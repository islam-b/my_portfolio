...
export const Sgs = () => {
    return <div >
        ...
        <div className="container px-5">
            ...
            <div className="mt-4">
                <h3 className=" px-2">SMS (School Management System)
                </h3>
            </div>
            <div className="row w-100">
                ...
                <div className="col-md-8 p-4">
                    ...
                    <div className='stack'>
                        ...
                        <img data-tip="ASP.NET Core" data-place='bottom' data-effect="solid" className='tech' src='/assets/tech/dotnet.png' />
                        <img data-tip="SQL Server" data-place='bottom' data-effect="solid" className='tech' src='/assets/tech/sql-server.png' />
